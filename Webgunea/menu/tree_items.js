...
var TREE_ITEMS = [
	['Proiektua XX', null,
			...
			['Memoria','../Proiektua/1-Memoria/1_0_memoria.htm',
				['Identifikazio orriak', '../Proiektua/1-Memoria/1_1_identifikazio_orriak.odt'],
				['Sarrera', '../Proiektua/1-Memoria/1_2_sarrera.odt'],
				['Xedea', '../Proiektua/1-Memoria/1_3_xedea.odt'],
				['Aurrekariak', '../Proiektua/1-Memoria/1_4_aurrekariak.odt'],
				['Egungo egoera', '../Proiektua/1-Memoria/1_5_egungo_egoera.odt'],
			    ['Arauak eta erreferentziak', '../Proiektua/1-Memoria/1_6_arauak_erreferentziak.odt',
                     ['<A HREF="../Proiektua/1-Memoria/1_6_arauak_erreferentziak.odt#Disposizio_legalak_eta_aplikatutako_arauak" target="nagusia">Xedapen legalak eta aplikatutako normak</A>'],
                     ['Bibliografia', '../Proiektua/1-Memoria/1_6_1_bibliografia.odt'],
                     ['Metodoak, herramintak, ereduak, metrikak eta prototipoak', '../Proiektua/1-Memoria/1_6_2_metodoak_tresnak_garapena.odt'],
                     ['Proiektuaren idazketan zehar aplikatutako kalitate kudeaketa plana', '../Proiektua/1-Memoria/1_6_3_kalitatearen_kudeaketa.odt'],
                     ['Beste erreferentziak', '../Proiektua/1-Memoria/1_6_4_beste_erreferentziak.odt']
                ],
				['Definizionak eta laburdurak', '../Proiektua/1-Memoria/1_7_def_laburdurak.odt'],
				['Hasierako betekizunak', '../Proiektua/1-Memoria/1_8_hasierako_betekizunak.odt'],
				['Norainokoa', '../Proiektua/1-Memoria/1_9_norainokoa.odt'],
				['Hipotesiak eta mugapenak', '../Proiektua/1-Memoria/1_10_hipotesiak_mugapenak.odt'],
				['Aukeren ikerketa eta egingarritasuna', '../Proiektua/1-Memoria/1_11_egingarritasuna.odt'],
				['Proposatutako sistemaren deskribapena', '../Proiektua/1-Memoria/1_12_proposatutako_sistema.odt'],
                ['Arrisku analisia', '../Proiektua/1-Memoria/1_13_arrisku_analisia.odt'],
                ['Proiektuaren antolaketa eta kudeaketa', '../Proiektua/1-Memoria/1_14_antolaketa_kudeaketa.odt'],
                ['Behin-behineko planifikazioa', '../Proiektua/1-Memoria/1_15_behin_behineko_planif.odt'],
                ['Aurrekontua', '../Proiektua/1-Memoria/1_16_aurrekontua.odt']
            ],
